...
export CC="$DIR_HOME/x-tools/${TARGET_TITLE}/bin/${TARGET_TITLE}-gcc -m64"
export CXX="$DIR_HOME/x-tools/${TARGET_TITLE}/bin/${TARGET_TITLE}-g++ -m64"
export CPP="$DIR_HOME/x-tools/${TARGET_TITLE}/bin/${TARGET_TITLE}-gcc -m64 -E"
export CXXPP="$DIR_HOME/x-tools/${TARGET_TITLE}/bin/${TARGET_TITLE}-g++ -m64 -E"
